...
exports.processNode = exports.searchAndReplaceNodeStrings = exports.getWpLinkRegex = exports.getImgTagMatchesWithUrl = exports.getImgSrcRemoteFileMatchesFromNodeString = exports.ensureSrcHasHostname = void 0;
...
var _createLocalFileNode = require("./create-local-file-node");
...
const fetchNodeHtmlImageMediaItemNodes = async ({
  ...
  for (const {
    ...
    if (!imageNode && htmlImgSrc) {
      ...
      // media item node.
      try {
        imageNode = await (0, _createLocalFileNode.createLocalFileNode)({
...
exports.getImgTagMatchesWithUrl = getImgTagMatchesWithUrl;
...
const replaceNodeHtmlImages = async ({
  ...
  if (imageUrlMatches.length && imgTagMatches.length) {
    ...
    const htmlMatchesWithImageResizes = await Promise.all(imgTagMatches.map(async ({
      ...
      var _imageNode$mediaDetai, _pluginOptions$html2, _ref2, _pluginOptions$html3, _pluginOptions$html4;
      ...
      if (gatsbyTransformerSharpSupportsThisFileType) {
        try {
          ...
          sharpImageData = await (0, _gatsbyPluginSharp.generateImageData)({
            file: fileNode,
            args: {
              width: maxWidth,
              quality,
              ...(pluginOptions === null || pluginOptions === void 0 ? void 0 : (_pluginOptions$html5 = pluginOptions.html) === null || _pluginOptions$html5 === void 0 ? void 0 : _pluginOptions$html5.gatsbyImageOptions)
            },
            pathPrefix,
            reporter,
            cache
    ...
    for (const matchResize of htmlMatchesWithImageResizes) {
      ...
      if (imageResize) {
        ...
        var _cheerioImg$attribs3, _cheerioImg$attribs4;
        ...
        const imgOptions = {
          ...
          className: `${(cheerioImg === null || cheerioImg === void 0 ? void 0 : (_cheerioImg$attribs3 = cheerioImg.attribs) === null || _cheerioImg$attribs3 === void 0 ? void 0 : _cheerioImg$attribs3.class) || ``} inline-gatsby-image-wrapper`,
          loading: `eager`,
          alt: cheerioImg === null || cheerioImg === void 0 ? void 0 : (_cheerioImg$attribs4 = cheerioImg.attribs) === null || _cheerioImg$attribs4 === void 0 ? void 0 : _cheerioImg$attribs4.alt,
          src: relativeUrl
        };
